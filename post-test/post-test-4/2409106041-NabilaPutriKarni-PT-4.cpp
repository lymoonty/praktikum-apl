...
void tambah_hewan(hewan daftar[], int &jumlah)
{
...
void ubah_hewan(hewan daftar[], int jumlah)
{
    string id;
...
void hapus_hewan(hewan daftar[], int &jumlah)
{
    string id;
...
int main()
{
    ...
    while (true)
    {
        ...
        {
        case 1:
            tambah_hewan(daftar_hewan, jumlah_hewan);
            break;
        case 2:
            tampilkan_hewan(daftar_hewan, jumlah_hewan);
            break;
        case 3:
            ubah_hewan(daftar_hewan, jumlah_hewan);
            break;
        case 4:
            hapus_hewan(daftar_hewan, jumlah_hewan);
            break;
        case 5:
